...
Default run needs no arguments:
    python hub_gene_annotation_mrna.py
"""
...
def main():
    ...
    ap.add_argument("--input", default="mrna_hub_genes_signed_top20.csv",
                    help="Input hub-gene CSV (Module, EnsemblID, GeneSymbol, kME).")
    ap.add_argument("--output", default="hub_genes_annotated_mrna.csv",
